...
Route::get('offtake_reports/GT_Top_BAs_report', 'OfftakeAnalyticsController@GT_Top_BAs_report');
Route::get('offtake_reports/MT_Top_BAs_report', 'OfftakeAnalyticsController@GT_Top_BAs_report');
