...
<body>
  {{ $data }}
  <div align="center"><u><h2>Attendance Report for the Month of November 2019</h2></u></div>
  ...
  <div class="css_bar_graph">
    ...
    <div class="graph">
      ...
      <!-- 250px = 100% -->
      <ul>
        <li class="bar nr_1 blue" style="height: 140px;"><div class="top"></div><div class="bottom"></div><span>58%</span></li>
        <li class="bar nr_2 blue" style="height: 80px;"><div class="top"></div><div class="bottom"></div><span>28%</span></li>
        <li class="bar nr_3 blue" style="height: 30px;"><div class="top"></div><div class="bottom"></div><span>9.5%</span></li>
        <li class="bar nr_4 blue" style="height: 20px;"><div class="top"></div><div class="bottom"></div><span>4.5%</span></li>
      </ul> 
    </div>
    
    <!-- graph label -->
    <div class="label"><span>Graph: </span>Attendance Report for the Month of November 2019</div>
    <!-- <div class="label"><span>Graph: </span>PJP Report for the Month of November 2019</div> -->
  </div>
  ...
  <div class="css_bar_graph">
    ...
    <!-- x_axis labels -->
    <ul class="x_axis">
      <li>% of Days worked (191/200)</li>
      <li>% of days PJP adhered (191/200)</li>
    ...
    <div class="graph">
      ...
      <!-- 250px = 100% -->
      <ul>
        <li class="bar nr_1 blue" style="height: 200px;"><div class="top"></div><div class="bottom"></div><span>89.58%</span></li>
        <li class="bar nr_2 blue" style="height: 200px;"><div class="top"></div><div class="bottom"></div><span>89.58%</span></li>
        <li class="bar nr_3 blue" style="height: 250px;"><div class="top"></div><div class="bottom"></div><span>100%</span></li>
      </ul> 
    </div>
    
    <!-- graph label -->
    <div class="label"><span>Graph: </span>Cumulative Report for the Month of November 2019</div>
    <!-- <div class="label"><span>Graph: </span>PJP Report for the Month of November 2019</div> -->
  </div>
  ...
  <div align="center">
    <table>
      ...
      <tr>
        ...
        <td>East</td>
        <td>North Bengal</td>
        <td>Kumardipta Ghosh</td>
        <td>BHABESH ROY</td>
        <td>North Bengal</td>
        <td>Subhrajit Biswas  </td>
        <td>PMSPL 3570</td>
        <td>1107</td>
        <td>TSI</td>
        <td>{{ \Carbon\Carbon::parse('08:43:45')->format('H:i') }}AM</td>
        <td>{{ \Carbon\Carbon::parse('08:43:45')->addHour(rand(1,3))->addMinute(rand(10, 30))->format('H:i') }}AM</td>
        <td>{{ \Carbon\Carbon::parse('04:05:42')->format('H:i') }}PM</td>
        <td>Yes</td>
        <td></td>
        <td></td>
        <td></td>
        <td>saktipur</td>
        <td>Saktipur, West Bengal</td>
        <td>Yes</td>
        <td></td>
        <td></td>
        <td>Yes</td>
      ...
      <tr>
        ...
        <td>1107</td>
        <td>TSI</td>
        <td>{{ \Carbon\Carbon::parse('08:58:24')->format('H:i') }}AM</td>
        <td>{{ \Carbon\Carbon::parse('08:58:24')->addHour(rand(1,3))->addMinute(rand(10, 30))->format('H:i') }}AM</td>
        <td>{{ \Carbon\Carbon::parse('02:37:35')->format('H:i') }}PM</td>
        <td>Yes</td>
        <td></td>
        <td></td>
        <td></td>
        <td>Rejinagar</td>
        <td>Rejinagar, West Bengal</td>
        <td>Yes</td>
        <td></td>
        <td></td>
        <td>Yes</td>
      ...
      <tr>
        ...
        <td>1107</td>
        <td>TSI</td>
        <td>{{ \Carbon\Carbon::parse('09:07:57')->format('H:i') }}AM</td>
        <td>{{ \Carbon\Carbon::parse('09:07:57')->addHour(rand(1,3))->addMinute(rand(10, 30))->format('H:i') }}AM</td>
        <td>{{ \Carbon\Carbon::parse('05:55:26')->format('H:i') }}PM</td>
        <td>Yes</td>
        <td></td>
        <td></td>
        <td></td>
        <td>sargachi</td>
        <td>Sargachi, West Bengal</td>
        <td>Yes</td>
        <td></td>
        <td></td>
        <td>Yes</td>
      ...
      <tr>
        ...
        <td>1107</td>
        <td>TSI</td>
        <td>{{ \Carbon\Carbon::parse('08:49:56')->format('H:i') }}AM</td>
        <td>{{ \Carbon\Carbon::parse('08:49:56')->addHour(rand(1,3))->addMinute(rand(10, 30))->format('H:i') }}AM</td>
        <td>{{ \Carbon\Carbon::parse('04:54:43')->format('H:i') }}PM</td>
        <td>Yes</td>
        <td></td>
        <td></td>
        <td></td>
        <td>muhula</td>
        <td>Muhula, West Bengal</td>
        <td>Yes</td>
        <td></td>
        <td></td>
        <td>Yes</td>
      ...
      <tr>
        ...
        <td>1107</td>
        <td>TSI</td>
        <td>{{ \Carbon\Carbon::parse('08:20:03')->format('H:i') }}AM</td>
        <td>{{ \Carbon\Carbon::parse('08:20:03')->addHour(rand(1,3))->addMinute(rand(10, 30))->format('H:i') }}AM</td>
        <td>{{ \Carbon\Carbon::parse('03:12:40')->format('H:i') }}PM</td>
        <td>Yes</td>
        <td></td>
        <td></td>
        <td></td>
        <td>domkol</td>
        <td>Domkol, West Bengal</td>
        <td>Yes</td>
        <td></td>
        <td></td>
        <td>Yes</td>
