...
<body>
  <div align="center"><u><h2>Attendance Report for the Month of December 2019</h2></u></div>
    ...
    <div class="graph">
      ...
      <ul>
        ...
        <li class="bar nr_1 blue" 
          style="height: 110px;"
        ><div class="top"></div><div class="bottom"></div><span>({{ $pcount1 }})%</span></li>
        <li class="bar nr_2 blue" style="height: 70px;"><div class="top"></div><div class="bottom"></div><span>({{ $pcount2 }})%</span></li>
