...
class GetLocations extends Command
{
    ...
    public function handle(Request $request)
    {
      ...
      $userLocation = UserLocation::whereDate('created_at', '=', '2020-09-26')
            ->where('user_id', '=', 375)
            ->latest()->first();
      if($userLocation) {
      ...
      $userLocation = UserLocation::whereDate('created_at', '=', '2020-09-27')
            ->where('user_id', '=', 375)
            ->latest()->first();
      if($userLocation) {
        $lat = $userLocation->content['coords']['latitude'];
      ...
      $userLocation = UserLocation::whereDate('created_at', '=', '2020-09-28')
            ->where('user_id', '=', 375)
            ->latest()->first();
      if($userLocation) {
        $lat = $userLocation->content['coords']['latitude'];
