    ...
    public function model(array $row)
    {
        // if ($row['Target'] != '' || $row['Achieved'] != '') {
            $data = [
                ...
                'month'  =>  request()->month,
                'year'  =>  request()->year,
                'baby_care'      =>  (array_key_exists('Baby Care', $row) &&  $row['Baby Care']) ?  $row['Baby Care']: null,
                'lip_serum'      =>  (array_key_exists('Lip Serum', $row) &&  $row['Lip Serum']) ?  $row['Lip Serum']: null,
                'ubtan_range'      =>  (array_key_exists('Ubtan Range', $row) &&  $row['Ubtan Range']) ?  $row['Ubtan Range']: null,
                'color_range'      =>  (array_key_exists('Color Range', $row) &&  $row['Color Range']) ?  $row['Color Range']: null,
                'hair_range'      =>  (array_key_exists('Hair Range', $row) &&  $row['Hair Range']) ?  $row['Hair Range']: null,
                'baby_range'      =>  (array_key_exists('Baby Range', $row) &&  $row['Baby Range']) ?  $row['Baby Range']: null,
                'color_care'      =>  (array_key_exists('Color Care', $row) &&  $row['Color Care']) ?  $row['Color Care']: null,
                'baby' => $row['Baby'],
