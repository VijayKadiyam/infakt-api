...
{
    protected $fillable = [
      'name', 'address', 'retailer_code', 'proprietor_name', 'phone', 'gst_no', 'bank_name', 'ac_no', 'ifsc_code', 'branch', 'cheque_path', 'retailer_category_id', 'retailer_classification_id', 'image_path', 'lat', 'lng', 'approved'
    ];
